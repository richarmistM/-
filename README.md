# 运筹学与数值优化算法库 (Optimization Algorithms Collection)

本项目包含四个独立的 Python 模块，分别实现了运筹学与数值分析中核心的优化算法，包括单纯形法、对偶单纯形法、梯度下降法以及整数规划的割平面法。图片为题目要求
...
本项目代码基于 Python 开发，推荐使用以下特定版本的依赖库以确保兼容性：
